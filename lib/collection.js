...
module.exports = class Collection {
  ...
  update(query, update, opts) {
    ...
    return this
      ...
      .then(connection => {
        ...
        commandResult.ok
        commandResult.n = commandResult.matchedCount
        commandResult.nModified = commandResult.modifiedCount
        commandResult.upserted = commandResult.upsertedId ? [{_id: commandResult.upsertedId}] : null
  ...
  remove(query, opts) {
    ...
    return this.connect()
      ...
      .then(commandResult => {
        commandResult.n = commandResult.deletedCount;
        return commandResult;
      });
  }
